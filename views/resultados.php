    ...
    <div class="sct-body">
        <div class="columns">
                        ...
                        <div class="accordion">
                            <div onload="mostrar()" class="section1">
                                ...
                                <div class="accordion__content">
                                    <label for="lbl-mesa">Seleccione... </label>
                                    <select name="mesa" mesa>
                                        <option>Todas</option>
                                        <option>Belgrano</option>
                                        <option>Centenario</option>
                                        <option>Sarmiento</option>
                                        <option>Nacional</option>
                                        <option>Sorribes</option>
                                        <option>Rosende</option>
                                    </select><br>
                                    <label id="lbl-mesa">Mesa N° </label>
                                    <select name="mesa" mesa>
                                        <option>Todas</option>
                                        <option>1001</option>
                                        <option>1002</option>
                                    ...
                                    <p align-content="center"><b>
                                       No están disponibles los resultados por mesa.</b>
                                    </p>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="accordion__content">
                                    <ol>
                                        ...
                                        <li><a link href="presiden.php" target="ifr-escuela"> Presidente</a></li>
                                        <li><a link href="parlanac.php" target="ifr-escuela"> Parlamentario Nacional</a></li>
                                        <li><a link href="diputados.php" target="ifr-escuela"> Diputados</a></li>
                                        <li><a link href="parlareg.php" target="ifr-escuela"> Parlamentario Regional</a></li>
            ...
            <div class="cont-ifr">
                ...
                <iframe class="ifr-escu" name="ifr-estadi" src="../views/fijoEstad.php" width="800" height="140"></iframe>
